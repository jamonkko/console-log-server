...
function run() {
  ...
  function parseProxies(proxiesArg) {
    ...
    var proxies = _fp["default"].flow(_fp["default"].castArray, _fp["default"].map(_fp["default"].trim), _fp["default"].compact, _fp["default"].map(function (proxyArg) {
      ...
      var parsedHost = _url["default"].URL ? new URL((0, _prependHttp["default"])(proxyHost)) : _url["default"].parse((0, _prependHttp["default"])(proxyHost)); // eslint-disable-line n/no-deprecated-api

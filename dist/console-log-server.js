...
var handleMiddlewareErrors = function handleMiddlewareErrors(err, req, res, next) {
  var logJsonParseError = function logJsonParseError() {
    ...
    var index = _lodash2.default.toNumber(positionMatches[1]);
  ...
  var logXmlParseError = function logXmlParseError() {
    ...
    var line = _lodash2.default.toNumber(lineErrorMatches[1]);
    var lineWithError = _lodash2.default.last(req.rawBody.split('\n', line));
...
var port = _lodash2.default.toNumber(process.env.PORT || 3000);
app.listen(port);
